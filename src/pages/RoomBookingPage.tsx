          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-10">
              <div className="lg:col-span-2">
                          ...
                          <div className="flex space-x-4">
                            {['4', '7', '14'].map((day) => (
                              <Button
                                ...
                                className={cn(
                                  "flex-1",
                                  bookingData.duration === day ? "bg-amber-500 hover:bg-amber-600" : ""
                                )}
                                onClick={() => setDuration(day as any)}
                              >
                      ...
                      <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                        <p className="text-sm text-amber-800">
                          <strong>Selected Stay:</strong> {bookingData.startDate 
                            ? `${format(bookingData.startDate, 'MMM dd, yyyy')} to ${
                                calculateEndDate() 
                ...
                {(activeStep === 'room' || activeStep === 'checkout') && (
