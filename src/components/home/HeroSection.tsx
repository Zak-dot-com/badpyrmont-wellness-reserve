    ...
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full container mx-auto px-4">
        ...
        <div className="flex-grow flex flex-col justify-center items-center text-center pt-16 md:pt-24">
          ...
          >
            <img 
              src="public/lovable-uploads/78397ad2-eb1f-43fb-9dca-2690a664b4ba.png" 
          ...
          <motion.p 
            className="mt-4 text-base md:text-lg text-white max-w-xl"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link to="/booking?bookingType=package">
              <Button size="lg" className="bg-amber-500 hover:bg-amber-400 text-neutral-50">
                Explore Packages
              </Button>
            </Link>
            <Link to="/book-room">
