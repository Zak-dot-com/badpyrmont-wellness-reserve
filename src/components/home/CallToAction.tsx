...
const CallToAction = () => {
  ...
  return <section ref={sectionRef} className="py-24 text-white bg-cover bg-center relative" style={{
    backgroundImage: "url('https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=1470&auto=format&fit=crop')"
  }}>
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/40 py-0"></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        duration: 0.7
          ...
          <Link to="/booking">
            <Button size="lg" className="bg-white text-black hover:bg-opacity-90 px-12 py-6 rounded-none text-base tracking-wide">
              Reserve Your Stay
            </Button>
          </Link>
        </motion.div>
